...
setup(
    ...
    package_data={
        "quality_control": ["*.txt", "*.json", "*.yaml", "py.typed"],
    },
    install_requires=collect_requirements(),
    python_requires=">=3.10",
    entry_points={
        "console_scripts": [
            "fiplconfig.build_uml=quality_control.uml_builder:main",
            "fiplconfig.check_uml=quality_control.static_checks.check_uml:main",
            ...
            "fiplconfig.check_module_usage=quality_control.static_checks.check_module_usage:main",
            ...
            "fiplconfig.sync_docs=quality_control.docs_sync.create_external_pr:main",
        ]
    },
